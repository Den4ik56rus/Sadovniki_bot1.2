...
- CRITICAL: DB schemas 81-83 + 93 NOT YET APPLIED ON PRODUCTION — must apply in order (82 → 83 → 81 → 93)
- DATA NEEDED: `data/quiz_solutions/` needs PDFs — use `scripts/sync_presentations_to_quiz.py` after generating presentations
