...
interface MenuItem {
  id: View | 'deals-group' | 'lists-group' | 'stats-group' | 'content-group'
...
const STATIC_MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'tasks', icon: Icons.tasks, label: 'Задачи' },
  {
    ...
    submenu: [
      ...
      { id: 'image-generator', label: 'Генератор картинок' },
      { id: 'batch-presentations', label: 'Пакет: по проблемам' },
      { id: 'batch-article-presentations', label: 'Пакет: по статьям' },
    ],
  },
