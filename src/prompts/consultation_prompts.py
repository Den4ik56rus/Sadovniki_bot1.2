...
5. Объём ответа: 100-180 слов МАКСИМУМ. НЕ БОЛЕЕ 2000 символов.
6. Формат: короткие абзацы или нумерованный список.
7. КРИТИЧНО: Ответ ОБЯЗАТЕЛЬНО должен уместиться в ОДНО сообщение. Будь лаконичен."""
...
Объём ответа: 600-1000 слов (5000-7500 символов). Пиши подробно и развёрнуто."""
...
5. Объём ответа: 600-1000 слов (5000-7500 символов). ОБЯЗАТЕЛЬНО пиши развёрнуто.
6. Структурируй ответ с подзаголовками и нумерованными списками.
7. Включи важные нюансы и предостережения.
8. КРИТИЧНО: Ответ должен быть ДОСТАТОЧНО ДЛИННЫМ — минимум 5000 символов."""
