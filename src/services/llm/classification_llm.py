...
async def detect_category_and_culture(text: str) -> tuple[str, str, float, int]:
    ...
    system_prompt = (
        ...
        "4. 'защита растений' - болезни, вредители, обработки, лечение\n"
        "5. 'улучшение почвы' - pH, кислотность, структура почвы, дренаж\n"
